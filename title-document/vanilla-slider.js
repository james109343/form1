...
var VanillaSlider = /*#__PURE__*/ (function () {
  ...
  function VanillaSlider(containerId) {
    ...
    this.webpSupported(function (isWebpSupported) {
      ...
      _this.bullets =
        typeof _this.bullets === "boolean" ? _this.bullets : false;
      _this.bulletsHide =
        typeof _this.bulletsHide === "boolean" && _this.bullets
          ? _this.bulletsHide
          : false;
      _this.arrows = typeof _this.arrows === "boolean" ? _this.arrows : true;
      _this.arrowsHide =
        typeof _this.arrowsHide === "boolean" && _this.arrows
          ? _this.arrowsHide
          : true;
      _this.swipe = typeof _this.swipe === "boolean" ? _this.swipe : true;
      _this.auto = typeof _this.auto === "boolean" ? _this.auto : false;
      _this.autoTime =
        typeof _this.autoTime === "number" ? _this.autoTime : 10000;
      _this.autoPauseOnHover =
        typeof _this.autoPauseOnHover === "boolean"
          ? _this.autoPauseOnHover
          : true;
      _this.webp =
        (typeof _this.webp === "boolean" ? _this.webp : false) &&
        isWebpSupported;
      _this.staticTextPosition =
        typeof _this.staticTextPosition === "string"
          ? _this.staticTextPosition
          : "SW"; // check color
      ...
      if (_this.bulletColor) {
        ...
        _this.bulletColor = isColor(_this.bulletColor)
          ? _this.bulletColor
          : "red";
      } else {
      ...
      _this.images.forEach(function (image, index) {
        ...
        imageElement.style.height = "min-content";
      ...
      if (_this.bullets) {
        ...
        _this.imageElements.forEach(function (element, index) {
          ...
          bullet.style.transition =
            "all " + _this.transitionTime / 1000 + "s linear";
        ...
        if (_this.bulletsHide) {
          ...
          _this.bulletContainer.style.transition =
      ...
      _this.resizeContainer = function () {
        ...
        var imageXYRatio =
          _this.imageElements[0].naturalWidth /
          _this.imageElements[0].naturalHeight;
      ...
      _this.goToSlide = function (newIndex) {
        ...
        if (
          ...
          newIndex < 0 ||
          newIndex + 1 > _this.imageElements.length
        ) {
      ...
      _this.setSlideText = function (index) {
        var appendTextOverlay = function appendTextOverlay(
          title,
          body,
          position,
          index
        ...
        if (_this.staticTextBody || _this.staticTextTitle) {
          if (!_this.textOverlay) {
            appendTextOverlay(
              _this.staticTextTitle,
              _this.staticTextBody,
              _this.staticTextPosition,
              null
            );
          }
          ...
          if (_this.images[index].textTitle || _this.images[index].textBody) {
            appendTextOverlay(
              _this.images[index].textTitle,
              _this.images[index].textBody,
              _this.images[index].textPosition,
              index
            );
          }
        }
      ...
      _this.revealSlideText = function () {
        if (_this.textOverlay) {
          var revealEffect = setInterval(function () {
            _this.textOverlay.style.opacity =
              parseFloat(_this.textOverlay.style.opacity) + parseFloat(0.1);
      ...
      _this.transitionSlide = function (newIndex, callback) {
        ...
        _this.slideFadeOut(
          _this.imageElements[_this.currentIndex],
          function () {
